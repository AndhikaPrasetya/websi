...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data_project = $query->paginate(10);
        
        return view('dashboard.master.project.list',compact('data_project','title','breadcrumb'));
    }
    ...
    {
        return view('dashboard.master.project.create');
    }
...
// dd($data);
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.master.project.edit', $data)->with('data berhasil diubah');
    }
    ...
    public function update(Request $request, $id)
{
    ...
    public function destroy($id)
    {
        ...
        if ($data->foto) {
            Storage::disk('public')->delete('project/' . $data->foto);
        }
