...
class GaleriKegiatanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data_galeri = $query->paginate(10);
        
        return view('dashboard.master.galeri.list',compact('data_galeri','title','breadcrumb'));
    }
    ...
    {
        return view('dashboard.master.galeri.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.master.galeri.edit', $data)->with('data berhasil diubah');
    }
    ...
    public function update(Request $request, $id)
{
    ...
    galeriKegiatan::where('id', $id)->update($data);
    ...
    public function destroy($id)
    {
        ...
        if ($data->foto) {
            Storage::disk('public')->delete('galeri/' . $data->foto);
        }
    
        // Hapus data dari database
        $data->delete();
    
        return redirect()->route('galeri-kegiatan.index')->with('success','Berhasil menghapus data');
