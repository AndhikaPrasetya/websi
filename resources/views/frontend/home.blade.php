...
@section('content')
    <section class="banner bg-tertiary position-relative overflow-hidden" style="height: 100vh; ">
        <div class="container ">
            <div class="row align-items-center justify-content-center" style="padding: 50px 40px; margin: 0 auto; ">
                <div class="col-lg-6 mb-2 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        <h1 class="text-capitalize mb-4">HIMSISFO UMB</h1>
                        <p class="mb-4">HIMSISFO UMB is a student organization that runs an executive function in the
                            Faculty
                            of Economics and Business, Universitas Indonesia. We aim to be active, responsive, and
                            constructive through various actions, devotions, and services.</p> <a type="button"
                            class="custom-button" href="#">See More<span style="font-size: 14px;"
                                class="ms-2 fas fa-arrow-right"></span></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="/foto/himsisfo.png"
        ...
        {{-- <div class="jumbotron" style="background-image: url(/frontend/public/assets/img/hero/hero-img.png)">
            <div class="container">
    ...
    <section class="pt-5 pt-md-9 mb-6" style="height: 100vh;" id="feature">

        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block"
            style="background-image:url(/frontend/public/assets/img/category/shape.png);opacity:.5;">
        </div>
        <!--/.bg-holder-->

        <div class="container" style="padding:180px 0 0 0">
            <h1 class="fs-9 fw-bold mb-4 text-center">Kami Sebagai Wadah Minat dan Bakat<br
                    class="d-none d-xl-block" />Serta memberikan Informasi kepada<br class="d-none d-xl-block" /> Mahasiswa
                Sistem Informasi </h1>
            <div class="row justify-content-center" style="padding-left: 90px">
                <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3"
                        src="/frontend/public/assets/img/category/icon1.png" width="85" alt="Feature" />
                    <h4 class="mb-3">Magang</h4>
                    <p class="mb-0 fw-medium text-secondary">While most people enjoy casino gambling,</p>
                </div>
                <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3"
                        src="/frontend/public/assets/img/category/icon2.png" width="85" alt="Feature" />
                    <h4 class="mb-3">Kampus Merdeka</h4>
                    <p class="mb-0 fw-medium text-secondary">Sports betting,lottery and bingo playing for the fun</p>
                </div>

                <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3"
                        src="/frontend/public/assets/img/category/icon4.png" width="85" alt="Feature" />
                    <h4 class="mb-3">Seminar/Workshop</h4>
                ...
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" href="service-details.html">
                        <div class="block"> <span class="colored-box text-center h3 mb-4">02</span>
                            <h3 class="mb-3 service-title">Dies Natalis Himsisfo</h3>
                            <p class="mb-0 service-description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                                sed
                                diam nonumy
                                eirmod</p>
                ...
                <div class="col-lg-4 col-md-6 service-item">
                    <a class="text-black" href="service-details.html">
                        <div class="block"> <span class="colored-box text-center h3 mb-4">03</span>
                            <h3 class="mb-3 service-title">SI FEST</h3>
                            <p class="mb-0 service-description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                                sed
                                diam nonumy
                                eirmod</p>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="/frontend/img/blog/blog-1.png" alt="">
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="/frontend/img/blog/blog-2.png" alt="">
            <div class="card-blog-body">
              <a href="#">
                <h4>Forest responds to consultation smoking in al fresco.</h4>
              </a>
        ...
        <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="/frontend/img/blog/blog-3.png" alt="">
            <div class="card-blog-body">
              <a href="#">
                <h4>Forest responds to consultation smoking in al fresco.</h4>
              </a>
