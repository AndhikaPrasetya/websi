	  ...
	  <div class="row">
		...
		<div class="col-md-4">
		  <div class="card mb-4 shadow-sm">
			  <img class="card-img" loading="lazy" decoding="async" src="storage/galeri/{{ $item['foto'] }}" alt="Post Thumbnail">
			<div class="card-body">
			  ...
			  <div class="d-flex justify-content-between align-items-center">
				<div class="btn-group">
				  <button type="button" class="btn btn-sm btn-outline-secondary"><a href="{{route('readmoreGaleri', $item->slug)  }}">Read more</a></button>
