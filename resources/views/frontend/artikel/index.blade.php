...
<section class="page-header bg-tertiary">
	<div class="container">
		<div class="row">
			<div class="col-8 mt-4 mx-auto text-center">
				<h2 class="mt-5 mb-3 text-capitalize">Seminar</h2>
	...
	<div class="container">
		<div class="row">
			<div class="col">
				<div class="me-lg-4">
					<div class="row gy-5">
                        @foreach ($data_seminar as $item)
						@if ($item->status == 'publish')
						
						<div class="col-md-6" data-aos="fade">
							<article class="blog-post">
								<div class="post-slider slider-sm rounded">
									<img loading="lazy" decoding="async" src="storage/seminar/{{ $item['foto'] }}" alt="Post Thumbnail">
									
								</div>
								<div class="pt-4">
									<p class="mb-3">{{$item->created_at}}</p>
									<h2 class="h4"><a class="text-black" href="blog-details.html">{{$item->judul}}</a></h2>
									<p>Heading example Here is example of hedings. You can use this heading by following …</p> <a href="{{route('readmore', $item->slug)  }}" class="text-primary fw-bold" aria-label="Read the full article by clicking here">Read More</a>
								</div>
							</article>
						</div>
						@endif
