                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            <form action="{{route('humas.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row mb-2">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col">
                                        @if ($data->foto)
                                        <img src="{{asset('storage/divisi-humas/' . $data->foto)}}" alt="Foto" style="max-width: 100px;" class="mb-2">
                                        @endif
