            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="pb-3">
                            <a href="{{route('sosial.index')}}" class="btn btn-secondary"><<< Kembali </a>
                        </div>
                        <div class="basic-form">
                            <form action="{{route('sosial.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row mb-2">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col">
                                        @if ($data->foto)
                                        <img src="{{asset('storage/divisi-sosial/' . $data->foto)}}" alt="Foto" style="max-width: 100px;" class="mb-2">
                                        @endif
