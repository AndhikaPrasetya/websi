                            ...
                            <form action="{{route('divisi.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" name="nama_divisi" id="nama_divisi" class="form-control input-flat" value="{{$data->nama}}" >
                                    </div>
                                    <div class="col">
                                      <label for="deskripsi">deskripsi</label>
                                      <input type="text" name="deskripsi" id="deskripsi" class="form-control input-flat" value="{{$data->deskripsi}}">
                                    </div>
                                </div>
                                {{-- <div class="row mt-4">
                                    ...
                                    <div class="col">
                                        @if ($data->foto)
                                        <img src="{{asset('storage/divisi-divisi/' . $data->foto)}}" alt="Foto" style="max-width: 100px;" class="mb-2">
                                        @endif
