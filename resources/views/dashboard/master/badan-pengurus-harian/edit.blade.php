            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="pb-3">
                            <a href="{{route('bph.index')}}" class="btn btn-secondary"><<< Kembali </a>
                        </div>
                        <div class="basic-form">
                            <form action="{{route('bph.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row mb-2">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <select name="jabatan" id="jabatan" class="form-control">
                                            ...
                                            <option value="sekertaris" {{ $data->jabatan == 'sekertaris' ? 'selected' : '' }}>sekretaris</option>
                                        </select>
                                      </div>
                                   
                                    <div class="col">
                                        @if ($data->foto)
                                        <img src="{{asset('storage/bph/' . $data->foto)}}" alt="Foto" style="max-width: 100px;" class="mb-2">
                                        @endif
