        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('magang.index')}}">{{ $breadcrumb }}</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pb-3 d-flex justify-content-between">
                                <a href="{{ route('magang.create') }}" class="btn mb-4 mt-2 btn-info">+ Tambah Data</a>
                                <div class="search">
                                    <form action="{{ route('magang.index') }}" method="GET" class="d-flex">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data_magang as $key => $item)
                                            <tr>
                                                <td>{{ $data_magang->firstItem() + $key }}</td>
                                                <td>{!! $item->judul !!}</td>
                                                <td>{!! $item->deskripsi !!}</td>
                                                <td><img src="{{ asset('storage/Magang/' . $item->foto) }}"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('magang.destroy', $item->id) }}"
                                ...
                                <div>
                                    Showing 
                                    {{$data_magang->firstItem()}}
                                    to
                                    {{$data_magang->lastItem()}}
                                    of
                                    {{$data_magang->total()}}
                                </div>
