        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('galeri-kegiatan.index')}}">{{ $breadcrumb }}</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="pb-3 d-flex justify-content-between">
                                <a href="{{ route('galeri-kegiatan.create') }}" class="btn mb-4 mt-2 btn-info">+ Tambah Data</a>
                                <div class="search">
                                    <form action="{{ route('galeri-kegiatan.index') }}" method="GET" class="d-flex">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered zero-configuration">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($data_galeri as $key => $item)
                                            <tr>
                                                <td>{{ $data_galeri->firstItem() + $key }}</td>
                                                <td>{!! $item->judul !!}</td>
                                                <td>{!!Substr($item['deskripsi'], 0,500)!!}...</td>
                                                <td><img src="{{ asset('storage/galeri/' . $item->foto) }}"
                                                ...
                                                <td>{!! $item->status !!}</td>
                                                    <td>
                                                    <a href="{{ route('galeri-kegiatan.edit', $item->id) }}"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('galeri-kegiatan.destroy', $item->id) }}"
                                ...
                                <div>
                                    Showing 
                                    {{$data_galeri->firstItem()}}
                                    to
                                    {{$data_galeri->lastItem()}}
                                    of
                                    {{$data_galeri->total()}}
                                </div>
