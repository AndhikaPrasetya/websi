    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title">Tambah Informasi galeri-kegiatan</h3>
                        <div class="pb-3">
                            <a href="{{route('galeri-kegiatan.index')}}" class="btn btn-secondary"><<< Kembali </a>
                        </div>
                        <div class="basic-form">
                            <form action="{{route('galeri-kegiatan.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row mb-2">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col">
                                        @if ($data->foto)
                                        <img src="{{asset('storage/galeri/' . $data->foto)}}" alt="Foto" style="max-width: 100px;" class="mb-2">
                                        @endif
